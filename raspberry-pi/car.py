...
def set_motors(fr_f, fr_b, fl_f, fl_b, rl_f, rl_b, rr_f, rr_b,
    ...
    # swapped: fr_b->IN1, fr_f->IN2  (reverses all motors)
    GPIO.output(IN1, fr_b); GPIO.output(IN2, fr_f)
    GPIO.output(IN3, fl_b); GPIO.output(IN4, fl_f)
    GPIO.output(IN5, rl_b); GPIO.output(IN6, rl_f)
    GPIO.output(IN7, rr_b); GPIO.output(IN8, rr_f)
